...
import { redeem } from './redeemNote';
import { OnbUser } from "./types/onbUser";
import { checkAccountBalance, inviteUsingLink, send, receive, refresh, showContacts, exit } from '../src/walletActions';
...
export async function onboardViaLink() {
  ...
  const onbUser: OnbUser = {
    name: link.sender,
    address: link.sender_address // Cambia questo valore con l'indirizzo reale se disponibile
  };
