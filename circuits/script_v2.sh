...
npx circom -v -r artifacts/circuits/transaction$1.r1cs -w artifacts/circuits/transaction$1.wasm -s artifacts/circuits/transaction$1.sym v2_transfers/transaction$1.circom
...
sed -i "s/contract Verifier/contract $CUSTOM_NAME/" artifacts/circuits/Verifier$1.sol
